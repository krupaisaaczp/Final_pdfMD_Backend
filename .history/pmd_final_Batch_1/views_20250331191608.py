...
def analyze_pdf(request):
    ...
    # Create a new request-like dictionary to pass to PDFFileViewSet.create
    from django.utils.datastructures import MultiValueDict
    files_data = MultiValueDict({'file': [pdf_file]})  # Wrap in list to mimic request.FILES structure
    modified_request = request._request  # Access the underlying HttpRequest
    modified_request.FILES = files_data  # This is safe as a temporary attribute assignment

    # Call PDFFileViewSet.create
    viewset = PDFFileViewSet()
    viewset.request = modified_request
    response = viewset.create(modified_request)
