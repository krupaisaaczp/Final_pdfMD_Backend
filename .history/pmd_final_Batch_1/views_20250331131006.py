...
def analyze_pdf(request):
    ...
    # Rename the file parameter to match the ViewSet's expected field name
    request.FILES['file'] = request.FILES.pop('pdf_file')
    ...
    if response.status_code == status.HTTP_201_CREATED:
        ...
        for key, value in analysis.features.items():
            # Determine if the feature is suspicious (simplified logic - enhance based on your criteria)
            is_suspicious = False
