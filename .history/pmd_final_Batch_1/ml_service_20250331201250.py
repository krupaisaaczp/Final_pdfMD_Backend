...
def predict_malware(features):
    try:
        ...
        try:
            ...
            probability = 0.5
        result = "Malicious" if probability > 0.95 else "Benign"  # Higher threshold
        print(f"Prediction: {result}, Confidence: {probability}")  # Debug
...
def generate_report(pdf_path, report_filename):
    ...
    try:
        from fpdf import FPDF  # This line requires the fpdf package
